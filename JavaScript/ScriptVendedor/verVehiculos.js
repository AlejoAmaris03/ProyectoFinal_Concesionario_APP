function btnVerDetallesVenta(id){ //Se ejcuta cuando se quieren ver los detalles de un vehículo
...
function btnSeleccionarVehiculoVenta(id){ //Trae los datos del vehículo seleccionado por el vendedor
    $.ajax({
        url: "../../Controlador/ControladorVehiculo.php",
        method: "POST",
        data: {
...
function btnVistaVenta(){
    id = $("#idV").val();
    btnSeleccionarVehiculoVenta(id);
}